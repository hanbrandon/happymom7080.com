...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      title: t('family'),
      desc: t('familyDesc'),
      image: '/premium_postpartum_care_hero_1777749788097.png'
    }
  ];
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute top-8 left-8 pr-8">
                <h3 className="text-2xl font-bold text-white tracking-tight mb-2">{service.title}</h3>
                <p className="text-sm text-white/80 leading-relaxed font-medium">{service.desc}</p>
              </div>
